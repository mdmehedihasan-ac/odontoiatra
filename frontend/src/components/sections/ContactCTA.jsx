    ...
    <section className="relative py-28 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <motion.h2
          ...
          className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold text-pearl leading-tight mb-6"
        >
          Il tuo sorriso{" "}
          <br />
        ...
        >
          <a href="tel:+390571478087" className="btn-primary text-base py-4 px-8">
            <Phone size={18} /> Chiama ora
          </a>
          <a href="https://wa.me/393273938147" target="_blank" rel="noreferrer" className="btn-outline text-base py-4 px-8">
